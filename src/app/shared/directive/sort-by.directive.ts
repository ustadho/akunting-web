 ...
 */
import { AfterContentInit, ContentChild, Directive, Host, HostListener, Input, NgModule } from '@angular/core';
import { FaIconComponent } from '@fortawesome/angular-fontawesome';
import { IconDefinition } from '@fortawesome/free-solid-svg-icons';

import { JhiConfigService } from '../config/config.service';
...
@NgModule({
    declarations: [JhiSortByDirective, JhiSortDirective],
    exports: [JhiSortByDirective, JhiSortDirective]
})

export class JhiSortModule { }